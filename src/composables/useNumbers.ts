...
export function toShowFormated(amount: number | string, decimals: number): number | undefined {
  ...
  export function toSendFormated(amount: number | string, decimals: number): number | undefined {
